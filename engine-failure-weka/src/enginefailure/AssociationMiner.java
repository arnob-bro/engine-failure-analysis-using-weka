...
/**
 * AssociationMiner — discovers association rules between engine parameters
 ...
 *   temperature_level=high AND vibration_x_level=high_vibration → fault_condition=severe_fault
 *   rpm_level=high AND torque_level=high → fault_condition=moderate_fault
 */
