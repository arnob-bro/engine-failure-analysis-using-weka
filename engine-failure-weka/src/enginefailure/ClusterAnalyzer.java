...
/**
 * ClusterAnalyzer — applies unsupervised learning (K-Means) to detect patterns in engine telemetry.
 *
 * The class attribute is removed before clustering so the algorithm works
 * purely on the feature space. After clustering, the results are interpreted
 * to see if certain clusters correspond to higher fault severity conditions.
 */
public class ClusterAnalyzer {
     ...
     *
     * @param numClusters number of clusters (e.g. 3 or 4)
     */
    ...
    public void analyze(Instances data) throws Exception {
        ...
        // Print cluster assignments and cross-reference with fault severity
     ...
     *
     * @param data dataset with class attribute
     * @return dataset without class attribute
     * @throws Exception if filter fails
     */
    private Instances removeClassAttribute(Instances data) throws Exception {
        Remove removeFilter = new Remove();
        // Remove the class attribute (1-based index)
    ...
    /**
     * Prints cluster assignments for each instance and shows a cross-tabulation
     * of clusters vs. fault severity classes to interpret the clustering.
     *
     * @param originalData dataset with class labels
     * @param clusterData  dataset without class labels (used for clustering)
     * @throws Exception if cluster assignment fails
     */
    private void printClusterAssignments(Instances originalData, Instances clusterData) throws Exception {
        ...
        System.out.println("\nCluster vs. Fault Severity Cross-Tabulation:");
